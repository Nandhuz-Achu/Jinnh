...
const array = ['account poyi','Don','Eee','Good Morning','Hm','offer','poda myre','powli','romantic','sed','song','spam','Ajmal','Achu']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
